...
public class BWAcceptInvitationToGame extends AsyncTask<String, Void, String> {
    Context context;
    ...
    BWAcceptInvitationToGame(Context ctx) {
        context = ctx;
    }
    @Override
    protected String doInBackground(String... params) {
        String putInWaitURL = "http://q99710ny.bget.ru/accept_invitation.php";
        pl1 = params[0];
        pl2 = params[1];
