...
public class BWPutUserDataIntoDBviaVK extends AsyncTask<String, Void, String> {
    Context context;
    ...
    BWPutUserDataIntoDBviaVK(Context ctx) {
        context = ctx;
    }
    @Override
    protected String doInBackground(String... params) {
        String putInWaitURL = "http://q99710ny.bget.ru/put_user_from_VK.php";
        login = params[0];
        avatar = params[1];
        city = params[2];
        country = params[3];
